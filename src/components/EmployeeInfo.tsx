...
const EmployeeInfo:React.FC<EmployeeInfoProps> = ({ isOpen, onRequestClose, employeeInfo }) => {
    ...
    const [employeeInfoDetail, setEmployeeInfoDetail] = useState<Employee>()

  useEffect(() => {
    setEmployeeInfoDetail(employeeInfo);
  }, [])
  ...
  >
       ...
       <div className="flex min-h-full items-center justify-center p-4 text-center">
            <div className="relative bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              ...
              <h2 className="text-base font-semibold leading-6 text-gray-900">Register New Employee</h2>
    <div>
        ...
        <dl className="sm:divide-y sm:divide-gray-200">
            <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    {employeeInfoDetail?.name}lmdlmlf
                </dd>
            </div>
            <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500">
                ...
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                {employeeInfoDetail?.email}kadksl
                </dd>
            </div>
            <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500">
                ...
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                {employeeInfoDetail?.telephone_number}155
                </dd>
            </div>
            <div className="py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500">
                ...
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                    {employeeInfoDetail?.department}asf
                </dd>
            </div>
        </dl>
    </div>
